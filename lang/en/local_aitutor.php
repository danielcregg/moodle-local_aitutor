...
$string['privacy:metadata:provider'] = 'To generate a hint, the question, the student answer and the grader feedback are sent to the configured external AI provider. This plugin stores no data on the provider.';
