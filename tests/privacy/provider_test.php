...
/**
 * Privacy provider tests for local_aitutor.
 *
...
final class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_and_delete_for_user(): void {
        ...
        // The data exports.
        $this->export_context_data_for_user($user->id, $context, 'local_aitutor');
        $this->assertTrue(writer::with_context($context)->has_any_data());

        // Deleting for the user removes the row.
        $approved = new approved_contextlist($user, 'local_aitutor', [$context->id]);
        provider::delete_data_for_user($approved);
        $this->assertEquals(0, $DB->count_records('local_aitutor_hints', ['userid' => $user->id]));
    }
    ...
    public function test_delete_for_all_users_in_context(): void {
        ...
        $this->assertEquals(0, $DB->count_records('local_aitutor_hints', ['cmid' => $quiz->cmid]));
    }
}
