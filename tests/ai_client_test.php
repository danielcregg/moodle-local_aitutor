...
/**
 * Unit tests for the AI Tutor server-side client.
 *
...
final class ai_client_test extends \advanced_testcase {
    ...
    public function test_hint_requires_a_provider(): void {
        $this->resetAfterTest();
        set_config('provider', '', 'local_aitutor');
        set_config('model', 'some-model', 'local_aitutor');
        set_config('apikey', 'some-key', 'local_aitutor');
        try {
    ...
    public function test_hint_requires_a_model(): void {
        $this->resetAfterTest();
        set_config('provider', 'openai', 'local_aitutor');
        set_config('model', '', 'local_aitutor');
        set_config('apikey', 'some-key', 'local_aitutor');
        try {
            ai_client::hint('question', 'answer', 'feedback', 1);
    ...
    public function test_hint_requires_a_key(): void {
        $this->resetAfterTest();
        set_config('provider', 'openai', 'local_aitutor');
        set_config('model', 'gpt-4o-mini', 'local_aitutor');
        set_config('apikey', '', 'local_aitutor');
        try {
            ai_client::hint('question', 'answer', 'feedback', 1);
    ...
    public function test_hint_rejects_an_unknown_provider(): void {
        $this->resetAfterTest();
        set_config('provider', 'not-a-real-provider', 'local_aitutor');
        set_config('model', 'gpt-4o-mini', 'local_aitutor');
        set_config('apikey', 'some-key', 'local_aitutor');
        try {
            ai_client::hint('question', 'answer', 'feedback', 1);
